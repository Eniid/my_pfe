                ...
                @else
                    @if ($user->isFollowedByMe)
                        <form action="{{ $user->id }}/rem_f" method="post" class="add_f">
                            ...
                            <button><img src="{{ asset('img/remove_f.svg') }}" alt="" class="lm_img"><img
                                    src="{{ asset('img/d_remove.svg') }}" alt="" class="dm_img"></button>
                        </form>
                    @else
                    ...
                    <div class="profil__messages">
                        ...
                        @if ($user->id === auth()->id())
                            <form action="/profil/{{ $user->id }}/description" method="post" class="add_f desc_f">
                                @csrf
                                <textarea name="desc" id="desc_user" cols="30" rows="10" class="desc_text" placeholder="Discribe yourself to the other users">{{ $user->description }}</textarea>
                        ...
                        <a href="" href="/profil/{{ $follow->following->id}}" class="pp_link">
                            <div class="flex pp__box-qeel">
                                <div class="sm-pp__box {{ $follow->following->house}}_bg">
                                    <img src="@if ($follow->following->img)
                        ...
                        <a href="#">
                            <section class="sm-event">
                                ...
                                <span class="sm-event__date__place"><img src="/img/where.svg" width="11" height="13"
                                        ...
                                        height="13" class="dm_img" alt="place">{{ $part->event->place }}</span>
                            </section>
                        </a>
                    @endforeach
                </div>
